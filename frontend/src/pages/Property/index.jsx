    ...
    <div>
      ...
      <div style={{ maxWidth:1200, margin:'0 auto', padding:'24px 24px 60px' }}>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'2fr 1fr', gridTemplateRows:'1fr 1fr', gap:8, height:420, borderRadius:'var(--radius)', overflow:'hidden', marginBottom:8 }}>
          <div style={{ gridRow:'1/3', background: p.images?.[0] ? undefined : GRAD[0] }}>
            {p.images?.[0] && <img src={p.images[0].image} alt={p.title} style={{ width:'100%', height:'100%', objectFit:'cover' }} />}
          </div>
          {[1, 2].map((i) => (
            <div key={i} style={{ background: p.images?.[i] ? undefined : GRAD[i] }}>
              {p.images?.[i] && <img src={p.images[i].image} alt="" style={{ width:'100%', height:'100%', objectFit:'cover' }} />}
            </div>
          ))}
        </div>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'1fr 360px', gap:32, alignItems:'start', marginTop:24 }}>
          ...
          <div>
            ...
            <h1 style={{ fontSize:26, fontWeight:800, marginBottom:6 }}>{p.title}</h1>
